...
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate;      //Container 직접 실행. 실제 서블릿 컨테이너 실행여부로 MockTesting과 다른점이 있음
    ...
    @Test
    public void Update_변경된다() throws Exception {
        //given
        //값 생성
        Posts savedData = postsRepository.save(Posts.builder()
                .title("title")
                .content("content")
                .author("smallj")
                .build());
        Long updateId = savedData.getId();
